...
const ClockInOut = () => {
  ...
  return (
    <div className="clock-in-out-container">
      ...
      {/* Display clock entries grouped by day (without edit button) */}
            ...
            <div className="entry-item">
              ...
              <div className="entry-time">
                {new Intl.DateTimeFormat('en-US', {
                  ...
                  second: 'numeric',
                  timeZoneName: 'short',
                }).format(new Date(grouped[date].find(e => e.type === 'clockIn')?.timestamp))}
              </div>
            </div>
            <div className="entry-item">
              ...
              <div className="entry-time">
                {new Intl.DateTimeFormat('en-US', {
                  ...
                  second: 'numeric',
                  timeZoneName: 'short',
                }).format(new Date(grouped[date].find(e => e.type === 'clockOut')?.timestamp))}
              </div>
            </div>
          </div>
        ))}
